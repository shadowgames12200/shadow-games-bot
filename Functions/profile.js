...
async function profileuser(interaction, userID = null) {
    ...
    const PrimeiraCompra = await EstatisticasNode.FirstOrder(userID)
    const UltimaCompra = await EstatisticasNode.LastOrder(userID)
    const rendimento = await EstatisticasNode.Ranking(10, 'valorTotal', userID)
